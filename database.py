...
from errors.PasswordErrors import *
from errors.UserNameErrors import *
...
class DataBase(MongoClient):
    ...
    def clear_collection(self):
        """clear_collection deletes all collection (usernames and password)
        """
        self.collection.delete_many({})

    def set_collection(self, collection):
        """set_collection set / change a collection to insert data to
    ...
    def get_post_by_username(self, username):
        """get_post_by_username get post / query from database by giving username
